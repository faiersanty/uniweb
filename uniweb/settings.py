...
# Seguridad: la SECRET_KEY se lee desde variable de entorno en producción
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-+bdr70cl-b+^2a!7f5&ttq$xo9*h8t!qr6hwopvub0nq#j#sj=')

# DEBUG desactivado en producción (Railway pone DEBUG=False via variable de entorno)
